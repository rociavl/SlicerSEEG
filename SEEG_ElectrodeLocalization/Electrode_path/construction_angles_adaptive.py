...
def main(use_combined_volume=True, use_original_reports=True, 
    ...
    try:
        ...
        base_dir = r"C:\Users\rocia\Downloads\TFG\Cohort\Centroids\P5_BoltHeadandpaths_trial_success_interactive_split_hemishhere_yesterday"
...
#------------------------------------------------------------------------------
#exec(open(r'C:\Users\rocia\AppData\Local\slicer.org\Slicer 5.6.2\SEEG_module\SEEG_masking\Electrode_path\construction_angles_adaptive.py').read())