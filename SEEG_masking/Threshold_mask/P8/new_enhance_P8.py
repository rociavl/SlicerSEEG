...
def process_roi_plus_gamma_after(enhanced_volumes, final_roi, threshold_tracker):
    ...
    threshold = 0.274
    enhanced_volumes['DESCARGAR_2_gaussian_volume_roi_0.274'] = np.uint8(enhanced_volumes['2_gaussian_volume_roi'] > threshold)
    ...
    threshold = 0.572
    enhanced_volumes['DESCARGAR_2_tophat_0.572'] = np.uint8(enhanced_volumes['2_tophat'] > threshold)
    ...
    threshold = 118
    enhanced_volumes['DESCARGAR_2_wavelet_roi_150'] = np.uint8(enhanced_volumes['2_wavelet_roi'] > threshold)
...
def process_wavelet_roi(enhanced_volumes, roi_volume, threshold_tracker):
    ...
    threshold = 1759
    enhanced_volumes['DESCARGAR_NUEVO_NLMEANS_1759'] = np.uint8(enhanced_volumes['NUEVO_NLMEANS'] > threshold)
...
def process_original_idea(enhanced_volumes, threshold_tracker):
    ...
    # Threshold gamma corrected volume
    threshold = 36
    enhanced_volumes['DESCARGAR_ORGINAL_IDEA_gamma_correction_36'] = np.uint8(enhanced_volumes['ORGINAL_IDEA_gamma_correction'] > threshold)
    ...
    # Threshold sharpened volume
    threshold = 38
    enhanced_volumes['DESCARGAR_ORGINAL_IDEA_sharpened_38'] = np.uint8(enhanced_volumes['ORGINAL_IDEA_sharpened'] > threshold)
    ...
    # Threshold wavelet result
    threshold = 28
    enhanced_volumes['DESCARGAR_ORIGINAL_IDEA_wavelet_28'] = np.uint8(enhanced_volumes['ORIGINAL_IDEA_wavelet'] > threshold)
    ...
    threshold = 0.097
    enhanced_volumes['DESCARGAR_ORGINAL_IDEA_gaussian_2_0.097'] = np.uint8(enhanced_volumes['ORGINAL_IDEA_gaussian_2'] > threshold)
    ...
    # Threshold gamma corrected volume
    threshold = 19
    enhanced_volumes['DESCARGAR_ORIGINAL_IDEA_GAMMA_2_19'] = np.uint8(enhanced_volumes['ORIGINAL_IDEA_GAMMA_2'] > threshold)
    ...
    # Threshold top-hat result
    threshold = 0.082
    enhanced_volumes['DESCARGAR_OG_tophat_1_0.082'] = np.uint8(enhanced_volumes['OG_tophat_1'] > threshold)
...
def process_first_try(enhanced_volumes, roi_volume, threshold_tracker):
    ...
    threshold = 26
    enhanced_volumes['DESCARGAR_FT_gamma_correction_26'] = np.uint8(enhanced_volumes['FT_gamma_correction'] > threshold)
    ...
    # Threshold gaussian filtered volume
    threshold = 0.092
    enhanced_volumes['DESCARGAR_FT_gaussian_2_0.448'] = np.uint8(enhanced_volumes['FT_gaussian_2'] > threshold)
    ...
    # Threshold gamma corrected volume
    threshold = 25
    enhanced_volumes['DESCARGAR_FT_GAMMA_2_25'] = np.uint8(enhanced_volumes['FT_gamma_2'] > threshold)
    ...
    threshold = 24
    enhanced_volumes['DESCARGAR_FT_OPENING_24'] = np.uint8(enhanced_volumes['FT_opening'] > threshold)
    ...
    # Threshold eroded volume
    threshold = 25
    enhanced_volumes['DESCARGAR_FT_ERODE_2_25'] = np.uint8(enhanced_volumes['FT_erode_2'] > threshold)
...
#exec(open(r'C:\Users\rocia\AppData\Local\slicer.org\Slicer 5.6.2\SEEG_module\SEEG_masking\Threshold_mask\P8\new_enhance_P8.py').read())
