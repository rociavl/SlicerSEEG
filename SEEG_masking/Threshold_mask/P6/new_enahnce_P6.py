...
# Main execution
inputVolume = slicer.util.getNode('6_CTp.3D')  
inputROI = slicer.util.getNode('patient6_mask_5')  # Brain Mask 
# Output directory
outputDir = r"C:\Users\rocia\Downloads\TFG\Cohort\Enhance_ctp_tests\P6\TH45_histograms"
...
#exec(open(r'C:\Users\rocia\AppData\Local\slicer.org\Slicer 5.6.2\SEEG_module\SEEG_masking\Threshold_mask\P6\new_enahnce_P6.py').read())
